...
namespace Selenium_Sample.Gmail
{
    public class GmailClass : Base.BaseClass
    {
        ...
        public static void ReadDataFromExcel()
        {
            ...
            excel.PopulateInCollection(@"C:\Users\lavanya.g\source\repos\Selenium Sample\Selenium Sample\TestDataFiles\GmailLogin.xlsx");
        }
        ...
        public static void email_send()
        {
            try
            {
                ...
                attachment = new Attachment(@"C:\Users\lavanya.g\source\repos\Selenium Sample\Selenium Sample\Reports\index.html");
